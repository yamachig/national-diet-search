...
export default function Home() {
    ...
    React.useEffect(() => {
        ...
        (async () => {
            const response = await client.GET("/search_speeches", { params: { query: { question } } });
    ...
    React.useEffect(() => {
        ...
        (async () => {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_HOST ?? ""}/summarize_speech?question=${encodeURIComponent(question)}&speech=${encodeURIComponent(speech.speech)}`);
    ...
    }, [question, searchSpeechesResult, selectedSpeechID, summarizeSpeechResult?.id]);
